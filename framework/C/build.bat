...
set LIBSRC=src\vivi.c src\dna.c src\genome.c src\chromosome.c src\channel.c src\cell.c src\organism.c
...
:clean
del vivi_test.exe vivi_demo.exe density.exe vivi_sim.exe vivi.lib vivi_test_asan.exe vivi_test_asan.ilk vivi_test_asan.pdb *.obj 2>nul
