...
static VIVI_THREAD_LOCAL const char *par_err_sink;

/* GF(256) with the classic 0x11D polynomial and generator 2, from the
 * immutable tables in gf_tables.h -- no lazy init, no mutable state */
