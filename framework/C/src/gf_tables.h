/* gf_tables.h -- precomputed GF(256) exp/log tables (poly 0x11D, generator 2).
 * Immutable: shared by vivi/parity.h and vivi/rs.h, needs no init and is safe
 * to read from multiple threads. */
#ifndef VIVI_GF_TABLES_H
#define VIVI_GF_TABLES_H
#include <stdint.h>
static constexpr uint8_t VIVI_GF_EXP[512] = {
...
static constexpr uint8_t VIVI_GF_LOG[256] = {
