...
- Not production archival software — it is a rigorous toy: 8740-check test
...
vivi_test.exe        rem pass=8740 fail=0
...
| base quality | per-base confidence; `--soft` weights the consensus vote |
...
└── framework/
    ...
    └── C/
        ...
        ├── test/          8740-check self-test, density/sim tools, fuzz harnesses,
...
- **8740/8740** checks: 64 official Chaskey-12 vectors; codec round-trips
